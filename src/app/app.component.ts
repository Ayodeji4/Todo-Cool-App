...
export class AppComponent {
  ...
  //2. create a property in app.component.ts called "formTitl" and initialize the value of the form
  // title to be Todo Cool App. e.g "Tosin Cool App";
  formTit="Todo Cool App";
